...
Two instances live in this repo. **The setter (v0.3) is current.**

## Current: setter substrate v0.3

- `reason_setter.py` — state mutated only through setter calls; six hard
